<template>
  <div class="relative flex-1">
    ...
    <input
      v-model="search"
      type="text"
      class="w-full md:pl-10 pl-7 md:pr-4 pr-2 py-2 border-2 border-gray-200 rounded-md hover:border-gray-300 focus:outline-none focus:border-blue-500 md:text-base text-sm transition-colors"
